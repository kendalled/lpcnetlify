    ...
    <div id="quote-steps" :class="[bg === 0 ? 'shadow' : 'shadow']" class="relative z-10 mx-auto bg-white rounded-md max-w-7xl">
      ...
      <div class="flex justify-end px-4 py-4 border-t border-gray-200 sm:justify-between sm:px-6">
        ...
        <div class="w-auto h-auto">
          ...
          <button :disabled="choiceEmpty" :class="[choiceEmpty ? 'text-gray-700 bg-gray-100 hover:bg-gray-50 active:bg-gray-200' : 'text-white bg-blue-600 hover:bg-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 focus:bg-blue-500 active:bg-blue-600']" class="px-4 py-2 ml-2 text-sm font-medium transition duration-150 ease-in-out border border-transparent rounded-md shadow-sm focus:outline-none" @click.prevent="nextPage">
            Continue
          </button>
        </div>
      </div>
          ...
          [
            {
              ...
              sid: 'pr0',
              name: 'Die Struck',
              src: require('~/static/quote/diestruck.png')
            },
            {
              id: 1,
              sid: 'pr1',
              name: 'Soft Enamel',
              src: require('~/static/quote/softenamel.png')
            },
            {
              id: 2,
              sid: 'pr2',
              name: 'Hard Enamel',
              src: require('~/static/quote/cloisonne.png')
            },
            {
              id: 3,
              sid: 'pr3',
              name: 'Silk Screen',
              src: require('~/static/quote/silkscreen.png')
            },
            {
              id: 4,
              sid: 'pr4',
              name: 'Offset Printed',
              src: require('~/static/quote/offset2.png')
            }
          ]
          },
          {
          ...
          [
            {
              ...
              sid: 'pl1',
              name: 'Polished Gold',
              src: require('~/static/quote/HPGold.png')
            },
            {
              id: 2,
              sid: 'pl2',
              name: 'Polished Silver',
              src: require('~/static/quote/HPSilver.png')
            },
            {
              id: 3,
              sid: 'pl3',
              name: 'Polished Copper',
              src: require('~/static/quote/HPCopper.png')
            },
            {
              id: 4,
              sid: 'pl4',
              name: 'Polished Nickel',
              src: require('~/static/quote/HPNickel.png')
            },
            {
              id: 5,
              sid: 'pl5',
              name: 'Black Metal',
              src: require('~/static/quote/BlackMetal.png')
            },
            {
              id: 6,
              sid: 'pl6',
              name: 'Antique Gold',
              src: require('~/static/quote/AGold.png')
            },
            {
              id: 7,
              sid: 'pl7',
              name: 'Antique Silver',
              src: require('~/static/quote/ASilver.png')
            },
            {
              id: 8,
              sid: 'pl8',
              name: 'Antique Copper',
              src: require('~/static/quote/ACopper.png')
            },
            {
              id: 9,
              sid: 'pl9',
              name: 'Dual Plated',
              src: require('~/static/quote/DualPlated.png')
            },
            {
              id: 10,
              sid: 'pl10',
              name: 'Color Coated',
              src: require('~/static/quote/ColorCoated.png')
            }
          ]
          },
          {
          ...
          [
            {
              ...
              sid: 'sz0',
              name: '0.75 inch',
              src: require('~/static/sizing/penny.png')
            },
            {
              id: 1,
              sid: 'sz1',
              name: '1.00 inch',
              src: require('~/static/sizing/quarter.png')
            },
            {
              id: 2,
              sid: 'sz2',
              name: '1.25 inch',
              src: require('~/static/sizing/50centcoin.png')
            },
            {
              id: 3,
              sid: 'sz3',
              name: '1.50 inch',
              src: require('~/static/sizing/dollarcoin.png')
            },
            {
              id: 4,
              sid: 'sz4',
              name: '1.75 inch',
              src: require('~/static/sizing/golfball.png')
            }
          ]
          },
          {
          ...
          [
            {
              ...
              src: require('~/static/backings/new1.png')
            },
            {
              id: 1,
              sid: 'bk1',
              name: 'Black Rubber',
              src: require('~/static/backings/new2.png')
            },
            {
              id: 2,
              sid: 'bk2',
              name: 'Yellow Rubber',
              src: require('~/static/backings/new3.png')
            },
            {
              id: 3,
              sid: 'bk3',
              name: 'Jewelry Clutch',
              src: require('~/static/backings/new4.png')
            },
            {
              id: 4,
              sid: 'bk4',
              name: 'Deluxe Clutch',
              src: require('~/static/backings/new5.png')
            }
          ]
          },
          {
          ...
          [
            {
              ...
              sid: 'pk0',
              name: 'Poly Bag',
              src: require('~/static/quote/poly.jpg')
            },
            {
              id: 1,
              sid: 'pk1',
              name: 'Acrylic Case',
              src: require('~/static/quote/acryliccase.jpg')
            },
            {
              id: 2,
              sid: 'pk2',
              name: 'Velvet Bag',
              src: require('~/static/quote/velvet.jpg')
            },
            {
              id: 3,
              sid: 'pk3',
              name: 'Velvet Case',
              src: require('~/static/quote/velvetcase.jpg')
            }
          ]
          }
        ],
        ...
        [
          ...
          [
            {
              ...
              sid: 'c0',
              name: 'Color Coin',
              src: require('~/static/colorCoin.png')
            },
            {
              id: 1,
              sid: 'c1',
              name: 'No Color Coin',
              src: require('~/static/noColorCoin.png')
            }
          ]
          },
          {
          ...
          [
            ...
            },
            {
              ...
              sid: 'sz3',
              name: '2.00 inch',
              src: require('~/static/sizing/sodacan.png')
            },
            {
              id: 4,
              sid: 'sz4',
              name: '2.25 inch',
              src: require('~/static/sizing/poolball.png')
            },
            {
              id: 5,
              sid: 'sz5',
              name: '2.50 inch',
              src: require('~/static/sizing/tennisball.png')
            },
            {
              id: 6,
              sid: 'sz6',
              name: '2.75 inch',
              src: require('~/static/sizing/baseball.png')
            },
            {
              id: 7,
              sid: 'sz7',
              name: '3.00 inch',
              src: require('~/static/sizing/hockeypuck.png')
            }
          ]
          },
          {
