  ...
  <div class="relative py-16 overflow-hidden bg-white">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      <div class="mx-auto mb-6 text-lg max-w-prose">
        <p class="text-base font-semibold tracking-wide text-center text-blue-600 uppercase leading-6">
          Introducing
        </p>
        <h1 class="mt-2 mb-8 text-3xl font-extrabold tracking-tight text-center text-gray-900 leading-8 sm:text-4xl sm:leading-10">
      ...
      <div class="mx-auto text-gray-500 prose prose-lg">
