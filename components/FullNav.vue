      ...
      <div class="px-2 mx-auto max-w-7xl sm:px-4 lg:px-8">
        <div class="flex justify-between h-16">
          <div class="flex px-2 lg:px-0">
            ...
            <div class="flex items-center h-full" @click="closeAll">
              <nuxt-link title="Lapel Pins and Coins - Home" to="/" class="flex items-center flex-shrink-0 rounded-md focus:outline-none">
                ...
                <img data-not-lazy class="block w-auto h-7 lg:hidden" src="~/static/lapel.svg" alt="">
          ...
          <div class="items-center justify-end flex-1 hidden px-2 lg:ml-6 lg:flex">
            ...
            <nuxt-link id="quoteButton" to="/quote" title="Quote form" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white border border-transparent rounded-md shadow-sm whitespace-nowrap bg-gradient-to-r from-blue-600 to-light-blue-600 hover:from-blue-700 hover:to-light-blue-700">
              Free Quote
            </nuxt-link>
          </div>
