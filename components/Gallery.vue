      ...
      <div class="container mx-auto px-6 py-3">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center justify-end w-full">
            <button class="text-gray-600 focus:outline-none mx-4 sm:mx-0" @click="cartOpen = !cartOpen">
              <svg
                class="h-5 w-5"
                fill="none"
        ...
        <div class="relative mt-6 max-w-lg mx-auto">
          ...
          <input class="w-full border rounded-md pl-10 pr-4 py-2 focus:border-blue-500 focus:outline-none focus:ring" type="text" placeholder="Search">
        </div>
      </div>
    </header>
