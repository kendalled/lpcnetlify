    ...
    <div class="px-8 py-16 mx-auto max-w-7xl">
      <div class="relative">
        <div class="relative overflow-hidden rounded-lg shadow-2xl lg:flex">
          <div class="relative flex items-center justify-center h-56 lg:h-auto lg:w-5/12">
            <img class="absolute object-cover w-full h-full" src="https://stripe.com/img/v3/payments/overview/photos/slack.jpg" alt="">
          ...
          <div class="relative bg-white lg:w-7/12">
            <svg class="absolute w-24 h-full -ml-12 text-white" fill="currentColor" viewBox="0 0 100 100" preserveAspectRatio="none">
              <polygon points="50,0 100,0 50,100 0,100" />
            </svg>
            <div class="relative px-8 py-12 leading-relaxed text-gray-700 lg:py-24 lg:px-16">
              <p>
                As <strong class="font-medium text-gray-900">Slack</strong> grows rapidly, using Stripe helps them scale payments easily &mdash; supporting everything from getting paid by users around the world to enabling ACH payments for corporate customers.
              </p>
              <p class="mt-6">
        ...
        <div class="absolute inset-y-0 left-0 lg:flex lg:items-center">
          <button class="w-12 h-12 p-3 mt-24 -ml-6 bg-white rounded-full shadow-lg lg:mt-0">
        ...
        <div class="absolute inset-y-0 right-0 lg:flex lg:items-center">
          <button class="w-12 h-12 p-3 mt-24 -mr-6 bg-white rounded-full shadow-lg lg:mt-0">
            <svg class="w-full h-full text-indigo-900" fill="currentColor" viewBox="0 0 24 24">
