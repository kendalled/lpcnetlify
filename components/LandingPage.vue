  ...
  <div class="bg-white">
    <header>
      <div class="relative bg-white">
        <div class="flex items-center justify-between px-4 py-6 mx-auto max-w-7xl sm:px-6 md:justify-start md:space-x-10 lg:px-8">
          <div class="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              <span class="sr-only">Lapel Pins &amp; Coins</span>
              <img class="w-auto h-8 sm:h-10" src="~/static/logo.svg" alt="Logo">
            </a>
          </div>
          <div class="-my-2 -mr-2 md:hidden">
            <button type="button" class="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-light-blue-500">
          ...
          <nav class="hidden space-x-10 md:flex">
            <div class="relative">
              ...
              <button type="button" class="inline-flex items-center text-base font-medium text-gray-500 bg-white rounded-md group hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-blue-500" @click="flyoutOpen = !flyoutOpen">
                <span>Products</span>
                <!--
            ...
            -->
              ...
              >
                <div v-if="flyoutOpen" class="absolute z-10 w-screen max-w-md mt-3 -ml-4 transform lg:max-w-2xl lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                  <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    <div class="relative grid gap-6 px-5 py-6 bg-white sm:gap-8 sm:p-8 lg:grid-cols-2">
                      <a href="#" class="flex items-start p-3 -m-3 rounded-lg hover:bg-gray-50">
                        <div class="flex items-center justify-center flex-shrink-0 w-10 h-10 text-white rounded-md bg-gradient-to-r from-blue-600 to-light-blue-600 sm:h-12 sm:w-12">
                          <!-- Heroicon name: inbox -->
                          <svg
                            class="w-6 h-6"
                            xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="items-center justify-end hidden md:flex md:flex-1 lg:w-0">
            ...
            <a href="#" class="inline-flex items-center justify-center px-4 py-2 ml-8 text-base font-medium text-white border border-transparent rounded-md shadow-sm whitespace-nowrap bg-gradient-to-r from-blue-600 to-light-blue-600 hover:from-blue-700 hover:to-light-blue-700">
              Sign up
            </a>
          </div>
        </div>
      ...
      -->
        ...
        >
          <div v-show="mobileOpen" class="absolute inset-x-0 top-0 z-30 p-2 transition origin-top-right transform md:hidden">
            <div class="bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
              <div class="px-5 pt-5 pb-6">
                <div class="flex items-center justify-between">
                  <div>
                    <img class="w-auto h-8" src="~/static/logo.svg" alt="Logo">
                  </div>
                  <div class="-mr-2">
                    <button type="button" class="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-light-blue-500">
                ...
                <div class="mt-6">
                  <nav class="grid grid-cols-1 gap-7">
                    <a href="#" class="flex items-center p-3 -m-3 rounded-lg hover:bg-gray-50">
                      <div class="flex items-center justify-center flex-shrink-0 w-10 h-10 text-white rounded-md bg-gradient-to-r from-blue-600 to-light-blue-600">
                        <!-- Heroicon name: inbox -->
                        <svg
                          class="w-6 h-6"
                          xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="px-5 py-6">
                ...
                <div class="mt-6">
                  <a href="#" class="flex items-center justify-center w-full px-4 py-2 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-gradient-to-r from-blue-600 to-light-blue-600 hover:from-blue-700 hover:to-light-blue-700">
                    Sign up
                  </a>
    ...
    <main>
          ...
          <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
            ...
            <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
              <h1 class="text-4xl font-extrabold tracking-tight text-center sm:text-5xl lg:text-6xl">
                <span class="block text-white">Get customized pins</span>
              ...
              <p class="max-w-lg mx-auto mt-6 text-xl text-center text-light-blue-200 sm:max-w-3xl">
                We offer complimentary digital proofs of your custom designs. See why thousands of customers choose us to design &amp; manufacture their pins.
              </p>
              <div class="max-w-sm mx-auto mt-10 sm:max-w-none sm:flex sm:justify-center">
                <div class="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                  <a href="#" class="flex items-center justify-center px-4 py-3 text-base font-medium bg-white border border-transparent rounded-md shadow-sm text-light-blue-700 hover:bg-light-blue-50 sm:px-8">
                    Get started
                  </a>
                  <a href="#" class="flex items-center justify-center px-4 py-3 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-light-blue-500 bg-opacity-60 hover:bg-opacity-70 sm:px-8">
                    Live demo
                  </a>
                </div>
              </div>
        ...
        <div class="relative">
          <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
            <div class="max-w-xl px-4 mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
              <div>
                <div>
                  <span class="flex items-center justify-center w-12 h-12 rounded-md bg-gradient-to-r from-blue-600 to-light-blue-600">
                    <!-- Heroicon name: inbox -->
                    <svg
                ...
                <div class="mt-6">
                  ...
                  <div class="mt-6">
                    <a href="#" class="inline-flex px-4 py-2 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-gradient-to-r from-blue-600 to-light-blue-600 hover:from-blue-700 hover:to-light-blue-700">
                      Get started
                    </a>
                  </div>
                </div>
      ...
      <div class="bg-gradient-to-r from-blue-800 to-light-blue-700">
        ...
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
          <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
            <h2 class="text-sm font-semibold tracking-wide uppercase">
              <span class="text-transparent bg-gradient-to-r from-blue-300 to-light-blue-300 bg-clip-text">Valuable Metrics</span>
            </h2>
      ...
      <div class="bg-white">
        <div class="max-w-4xl px-4 py-16 mx-auto sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <span class="block text-transparent bg-gradient-to-r from-blue-600 to-light-blue-600 bg-clip-text">Get in touch or create an account.</span>
          </h2>
          <div class="mt-6 space-y-4 sm:space-y-0 sm:flex sm:space-x-5">
            <a href="#" class="flex items-center justify-center px-4 py-3 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-gradient-to-r from-blue-600 to-light-blue-600 hover:from-blue-700 hover:to-light-blue-700">
              Learn more
            </a>
            <a href="#" class="flex items-center justify-center px-4 py-3 text-base font-medium border border-transparent rounded-md shadow-sm text-light-blue-800 bg-light-blue-50 hover:bg-light-blue-100">
              Get started
            </a>
          </div>
        </div>
          ...
          <div class="mt-12 xl:mt-0">
            ...
            <form class="mt-4 sm:flex sm:max-w-md">
              ...
              <input
                ...
                autocomplete="email"
                required
                class="w-full min-w-0 px-4 py-2 text-base text-gray-900 placeholder-gray-500 bg-white border border-gray-300 rounded-md shadow-sm appearance-none focus:outline-none focus:ring-light-blue-500 focus:border-light-blue-500 focus:placeholder-gray-400"
                placeholder="Enter your email"
              >
              <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button type="submit" class="flex items-center justify-center w-full px-4 py-3 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-gradient-to-r from-blue-600 to-light-blue-600 hover:from-blue-700 hover:to-light-blue-700">
                  Subscribe
                </button>
              </div>
            </form>
